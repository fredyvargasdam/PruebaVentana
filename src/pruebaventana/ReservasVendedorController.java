...
public class ReservasVendedorController implements Initializable {
    ...
    @FXML
    private TableColumn<Reserva, String> tcProducto;
    @FXML
   ...
   //  private TableColumn<BirthdayEvent, Timestamp> tcEntrega;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            tcIdReserva.setCellValueFactory(new PropertyValueFactory<Reserva, Long>("id"));
            tcUsuario.setCellValueFactory(new PropertyValueFactory<Reserva, String>("user"));
            tcProducto.setCellValueFactory(new PropertyValueFactory<Reserva, String>("producto"));
            tcCantidad.setCellValueFactory(new PropertyValueFactory<Reserva, Integer>("cantidad"));
            tcDescripcion.setCellValueFactory(new PropertyValueFactory<Reserva, String>("descripcion"));
            tcRealizada.setCellValueFactory(new PropertyValueFactory<Reserva, Timestamp>("fechaReserva"));
            tcEntrega.setCellValueFactory(new PropertyValueFactory<Reserva, Timestamp>("fechaEntrega"));
          
           tcEstado.setCellValueFactory(new PropertyValueFactory<Reserva, EstadoReserva>("estado"));
